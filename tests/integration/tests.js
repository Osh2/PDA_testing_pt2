...
describe('calculator functionality', function() {
  ...
  it('should have functional operator buttons', function(){
    running_total = element(by.css('#running_total'));
  ...
  it('should be able to handle displaying negative numbers', function(){
    running_total = element(by.css('#running_total'));
    element(by.css('#number3')).click();
  ...
  it('should be able to handle displaying decimals', function(){
    running_total = element(by.css('#running_total'));
    element(by.css('#number3')).click();
  ...
  it('should be able to handle displaying large numbers', function(){
    running_total = element(by.css('#running_total'));
  ...
  it('should print error when trying to divide by zero', function(){
    running_total = element(by.css('#running_total'));
    element(by.css('#number3')).click();
    element(by.css('#operator_divide')).click();
